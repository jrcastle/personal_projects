...
process.GlobalTag.globaltag = "75X_dataRun2_ExpressHI_v2"
...
#           tag = cms.string('Alignments_27'),
#                   connect = cms.string('sqlite_file:/afs/cern.ch/cms/CAF/CMSALCA/ALCA_TRACKERALIGN/MP/MPproduction/mp1407/stowaway/alignments_split_MP.db')
#           ),
#  cms.PSet(record = cms.string('TrackerSurfaceDeformationRcd'),
#           tag = cms.string('Deformations_27'),
#                   connect = cms.string('sqlite_file:/afs/cern.ch/cms/CAF/CMSALCA/ALCA_TRACKERALIGN/MP/MPproduction/mp1407/stowaway/alignments_split_MP.db')
#           )
#  )
...
process.AlignmentTrackSelector.pMin = 8.0 #for 3.8T Collisions 3
#process.AlignmentTrackSelector.pMin = 4.9  #for 0T Collisions                                                                            
#process.AlignmentTrackSelector.pMax = 5.1 #for 0T Collisions
process.AlignmentTrackSelector.ptMin = 1.  #for 3.8T Collisions 0.65
